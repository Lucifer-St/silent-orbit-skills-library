...
|---|---:|---|
| Repository and package | `0.11.0-beta.7` | `0.11.x` beta line |
...
`0.11.0-beta.7` is the Phase 6B governance and documentation repair candidate.
...
No migration is required inside the v1 family. `0.11.0-beta.7` reads and writes
