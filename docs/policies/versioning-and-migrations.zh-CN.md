...
| Surface | 候选版本 | 兼容承诺 |
|---|---:|---|
| Repository / package | `0.11.0-beta.7` | `0.11.x` beta 系列 |
...
`0.11.0-beta.7` 是 Phase 6B Release Candidate：修复 Public 文档结构、package 链接闭包与发布治理，
...
v1 系列内部无需迁移。`0.11.0-beta.7` 读写固定的 v1 contracts。遇到不支持的
