...
https://github.com/Lucifer-St/silent-orbit-skills-library/releases/tag/v0.13.1-beta.1
...
- Release 链接或版本不是 `v0.13.1-beta.1`；
- SHA256 不一致；
- Node 不是 24；
...
所以这里不是 `0.13.1-beta.1` 属于正常情况。这个包没有发布到 npm registry。
