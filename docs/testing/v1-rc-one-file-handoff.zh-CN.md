...
> 版本：`v0.12.0-beta.1`<br>
> 唯一可信入口：https://github.com/Lucifer-St/silent-orbit-skills-library/releases/tag/v0.12.0-beta.1<br>
...
`npm install ./silent-orbit-skills-library-0.12.0-beta.1.tgz` 可以按包声明解析正常的公开依赖，
...
- 只认 `https://github.com/Lucifer-St/silent-orbit-skills-library/releases/tag/v0.12.0-beta.1`。禁止使用 `latest`、其他 tag、本地作者路径、
  其他压缩包或未发布构建。
...
`silent-orbit-skills-library-0.12.0-beta.1.tgz` 和 starter；实际执行 Docker 时也必须覆盖两个 Docker
