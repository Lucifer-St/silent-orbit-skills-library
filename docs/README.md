...
The timestamp is the note's first Git commit time normalized to UTC. The brief
is a stable lowercase kebab-case summary. Once published, a note's timestamp
does not change when the note is edited.
